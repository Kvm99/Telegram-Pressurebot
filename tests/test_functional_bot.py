...
def test_prepare_data_from_potgresql_to_graph(monkeypatch):
    ...
    assert prepare_data_from_potgresql_to_graph(pressure_list, "r") == (["130", "213"], ["70", "42"], ["2019-04-20", "2019-04-22"], "r")
    ...
    assert prepare_data_from_potgresql_to_graph(pressure_list, "l") == (["130"], ["70"], ["13:16"], "l")
...
def test_find_dates_in_period():
    assert find_dates_in_period("21.04.2019", "22.04.2019") == ["2019-04-21", "2019-04-22"]
...
def test_find_requested_data_from_all_of_db():
    pass
    #find_requested_data_from_all_of_db(pressure_data, date_generated)
